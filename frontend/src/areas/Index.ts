export { default as ClientiPage } from "./Clienti/ClientiPage";
export { default as PalestraPage } from "./Palestra/PalestraPage";
export { default as ProfiloPage } from "./Profilo/ProfiloPage";
